            ...
            <div className={styles.contact}>
                ...
                <div>
                    ...
                    <ul className={styles.adress}>
                        ...
                        <li><b>CNPJ: 41.664.645/0001-06</b></li>
                    </ul> 
                </div>
            </div>
                ...
                <div className="mapouter" style={{position:"relative",
                    ...
                    <div className="gmap_canvas" style={{overflow:"hidden",
                        ...
                        <iframe 
                            ...
                            height="300"
                            id="gmap_canvas"
                            src="https://maps.google.com/maps?q=Rua%20Verbo%20Divino,%202001%20Torre%20B%20-%20Conj.%201007&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                            frameBorder="0"
                            scrolling="no"
                            marginHeight="0"
                            marginWidth="0">
                        </iframe>
                      <a href="https://www.embedgooglemap.net">embed google map html</a>
                    </div>
                </div>
            </div>
